                    ...
                    <div className="container px-5">
                        ...
                        <form>
                            ...
                            <div className="form-group mb-4">
                                ...
                                <input type="text" className="form-control" id="perusahaan" name="perusahaan" placeholder="Masukan nama perusahaan" />
                            </div>
                            <div className="form-group mb-4">
                                <label htmlFor="perusahaan" className={styles.labelName}>Bidang Perusahaan</label>
                                <input type="text" className="form-control" id="perusahaan" name="perusahaan" placeholder="Masukan bidang perusahaan" />
                            </div>
                            <div className="form-group mb-4">
